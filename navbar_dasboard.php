...
<li><a href="test.php"><i class="icon-file-alt icon-large"></i>&nbsp;Diagonoistics</a></li>
<li><a href="hospitals.php?hospitals=Make+Appointments"><i class="icon-file-alt icon-large"></i>&nbsp;Doctor List</a></li>
