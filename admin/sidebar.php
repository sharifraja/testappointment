		...
		Time is:&nbsp;<input type="submit" class="trans" name="face" value="">
                        ...
                        ?>
								...
								<ul class="nav nav-tabs nav-stacked">
									...
									<li><a href="service.php"><i class="icon-medkit	icon-large"></i>&nbsp;Patient History<i class="icon-arrow-right icon-large"></i></a></li>
									<li><a href="test.php"><i class="icon-medkit	icon-large"></i>&nbsp;Generate Prescription<i class="icon-arrow-right icon-large"></i></a></li>
